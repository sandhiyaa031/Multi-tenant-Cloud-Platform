-- test_functions_procedures_triggers.sql
--
-- PostgreSQL 18 / pgAdmin compatible.
...
--   10_triggers.sql
--
-- Intentionally failing cases are caught inside PL/pgSQL so pgAdmin
-- continues executing the rest of the test suite.
